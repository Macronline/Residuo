...
namespace REM.BC2.Security
{
    ...
    public class Usuario : Singular
    {
        ...
        public ClienteMunicipio oClienteMunicipio = null;
        ...
        public void ReadMunic()
        {
            ClienteMunicipio munic = new ClienteMunicipio(this);
            munic.ReadByNombreUserMunic();
            this.oClienteMunicipio = munic;
            munic = null;
        }
